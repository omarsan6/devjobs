<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('Es necesario confirmar tu cuenta para continuar, revisa tu email y presiona sobre el botón verficar email') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600">
            {{ __('Hemos enviado un nuevo email de confirmación a la cuenta de registro') }}
        </div>
    @endif
